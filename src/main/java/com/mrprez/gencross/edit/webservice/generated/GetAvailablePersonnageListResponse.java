 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service.web.gencross.mrprez.com/}pluginDescriptor" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAvailablePersonnageListResponse {
    ...
    protected List<PluginDescriptor> _return;
     ...
     * 
     */
    public List<PluginDescriptor> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PluginDescriptor>();
        }
        return this._return;
    }
